...
class StudentModel
{
    ...
    public function insertImport()
    {
        ...
        $stmt->bindParam(':Name', $this->studentName);
        $stmt->bindParam(':LastName', $this->studentLastName);
        $stmt->bindParam(':Gender', $this->studentGender);
        $stmt->bindParam(':Phone', $this->studentPhone);
        $stmt->bindParam(':Email', $this->studentEmail);
        $stmt->bindParam(':Address', $this->studentAddress);
        $stmt->bindParam(':Modality', $this->studentModality);
        $stmt->bindParam(':vID', $this->VocationID);
