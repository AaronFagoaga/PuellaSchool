...
<head>
    ...
    <title>Agregar vocación</title>
</head>

<body>
    <div class="container mt-5">
        <div class="card p-4">
            <h2 class="mb-4">Creación de vocación</h2>
            <form action="" method="POST" name="frmCreate">
                <div class="mb-3">
                    <label for="name" class="form-label">Nombre:</label>
                    <input type="text" id="vocationName" name="vocationName" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label for="categorie" class="form-label">Descripción:</label>
                    <input type="text" id="vocationInfo" name="vocationInfo" class="form-control" required>
                </div>
