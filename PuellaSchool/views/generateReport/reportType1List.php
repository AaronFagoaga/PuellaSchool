...
<body>
    <div class="container">
        ...
        <div class="container">
            <p>Lista de estudiantes según la materia o vocación donde <b><?php echo $_SESSION["user"]; ?></b> creó el reporte. Si no lista por materia o vocación se mostrarán todos los registros donde haya realizado un reporte.</p>
        </div>
