...
<body>
    <div class="container mt-5">
        <div class="card p-4 shadow-lg">
            <h2 class="mb-4 text-center">Actualizar reporte</h2>
            <form action="" method="POST">
                <input type="hidden" id="UserID" name="UserID" value="<?= htmlspecialchars($reports->UserID) ?>">
                <div class="mb-3">
                    <label for="reportSubject" class="form-label">Asunto:</label>
                    <input type="text" id="reportSubject" name="reportSubject" value="<?= htmlspecialchars($reports->reportSubject) ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="reportDetails" name="reportDetails" class="form-control" rows="4" required><?= htmlspecialchars($reports->reportDetails) ?></textarea>
                </div>
