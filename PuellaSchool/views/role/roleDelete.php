        ...
        <div class="card p-4">
            ...
            <form action="" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" id="rolName" name="rolName" value="<?= htmlspecialchars($vocatio->rolName) ?>" class="form-control" disabled>
                </div>
                <div class="mb-3">
                    <label for="rolInfo" class="form-label">Descripción:</label>
                    <input type="text" id="rolInfo" name="rolInfo" value="<?= htmlspecialchars($vocatio->rolInfo) ?>" class="form-control" disabled>
                </div>
